...
import { LocationProvider, defaultLocation } from './src/context/LocationContext';
...
export default function App() {
  ...
  const [location, setLocation] = useState<LocationSelection>(defaultLocation ?? getMockLocation());
