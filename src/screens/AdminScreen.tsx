...
const styles = StyleSheet.create({
  ...
  sidebar: { width: 276, padding: 14, borderRightWidth: 1, borderRightColor: 'rgba(99,102,241,0.22)', backgroundColor: 'rgba(3,7,18,0.96)' },
  ...
  navItem: { minHeight: 42, borderRadius: 11, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 12 },
  navItemActive: { backgroundColor: '#6D3DFF', borderWidth: 1, borderColor: 'rgba(196,181,253,0.55)', shadowColor: '#7C3AED', shadowOpacity: 0.28, shadowRadius: 14, shadowOffset: { width: 0, height: 8 } },
  ...
  adminProfileCard: { minHeight: 58, marginTop: 14, padding: 10, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(15,23,42,0.92)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.18)' },
  ...
  exitButton: { minHeight: 42, marginTop: 12, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(15,23,42,0.96)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  exitText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
  main: { flex: 1 },
  topbar: { minHeight: 86, paddingHorizontal: 18, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(99,102,241,0.22)', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 16, backgroundColor: 'rgba(3,7,18,0.72)' },
  ...
  searchInput: { flex: 1, minHeight: 42, minWidth: 220, maxWidth: 390, paddingHorizontal: 14, borderRadius: 10, color: '#FFFFFF', backgroundColor: 'rgba(15,23,42,0.9)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.18)', fontWeight: '800' },
  liveBadge: { minHeight: 34, paddingHorizontal: 12, borderRadius: 10, flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: 'rgba(15,23,42,0.9)', borderWidth: 1, borderColor: 'rgba(34,197,94,0.26)' },
  liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#34D399' },
  liveText: { color: '#D1FAE5', fontSize: 11, fontWeight: '900' },
  bell: { width: 36, height: 36, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(15,23,42,0.9)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  bellText: { color: '#E2E8F0', fontSize: 12, fontWeight: '900' },
  dateRange: { minHeight: 36, paddingHorizontal: 12, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(15,23,42,0.86)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  ...
  metricCard: { flexGrow: 1, flexBasis: 220, minHeight: 142, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)', overflow: 'hidden' },
  ...
  sparkSegment: { flex: 1, borderRadius: 6, backgroundColor: '#7C3AED' },
  dashboardGrid: { marginTop: 14, flexDirection: 'row', flexWrap: 'wrap', gap: 14, alignItems: 'stretch' },
  marketHeader: { marginBottom: 14, padding: 18, borderRadius: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 14, backgroundColor: 'rgba(15,23,42,0.72)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.14)' },
  marketToolbar: { marginBottom: 14, borderRadius: 16, flexDirection: 'row', flexWrap: 'wrap', gap: 12, alignItems: 'flex-end', backgroundColor: 'rgba(15,23,42,0.78)' },
  filterBlock: { flexGrow: 1, flexBasis: 220, marginTop: 8 },
  filterPillRow: { gap: 8, paddingRight: 10 },
  filterPill: { minHeight: 36, paddingHorizontal: 12, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(30,41,59,0.9)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.14)' },
  filterPillActive: { backgroundColor: '#6D3DFF', borderColor: 'rgba(196,181,253,0.5)' },
  ...
  activityCard: { flexGrow: 1, flexBasis: 320, minHeight: 230, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  activityList: { gap: 12 },
  ...
  panel: { marginTop: 14, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  ...
  input: { minHeight: 44, paddingHorizontal: 12, borderRadius: 10, color: '#FFFFFF', backgroundColor: 'rgba(15,23,42,0.86)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)', fontWeight: '800' },
  inlineInput: { minHeight: 38, minWidth: 124, paddingHorizontal: 10, borderRadius: 9, color: '#FFFFFF', backgroundColor: 'rgba(15,23,42,0.86)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.14)', fontSize: 11, fontWeight: '800' },
  textArea: { minHeight: 132, paddingTop: 12, lineHeight: 18 },
  toggleGrid: { marginTop: 14, flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  toggleRow: { flexGrow: 1, flexBasis: 240, minHeight: 48, paddingHorizontal: 12, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'rgba(15,23,42,0.76)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.12)' },
  ...
  actionButton: { minHeight: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: '#5538FF', overflow: 'hidden' },
  actionButtonGradient: { minHeight: 40, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center' },
  secondaryButton: { paddingHorizontal: 16, backgroundColor: 'rgba(15,23,42,0.9)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.18)' },
  dangerButton: { backgroundColor: '#FF5D7A' },
  actionButtonText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  tinyButton: { minHeight: 32, paddingHorizontal: 10, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(30,41,59,0.94)', borderWidth: 1, borderColor: 'rgba(99,102,241,0.28)' },
  ...
  table: { minWidth: 920, borderRadius: 14, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(148,163,184,0.12)' },
  tableRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'rgba(148,163,184,0.1)', backgroundColor: 'rgba(15,23,42,0.5)' },
  tableCell: { width: 150, minHeight: 52, justifyContent: 'center', paddingHorizontal: 12, paddingVertical: 10 },
  tableHead: { color: '#A78BFA', fontSize: 11, fontWeight: '900', textTransform: 'uppercase', backgroundColor: 'rgba(30,41,59,0.95)' },
  ...
  categoryTile: { flexGrow: 1, flexBasis: 220, minHeight: 166, borderRadius: 16, padding: 14, borderWidth: 1, borderColor: 'rgba(148,163,184,0.14)' },
  ...
  locationTreeCard: { flexGrow: 1, flexBasis: 280, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  ...
  userCard: { flexGrow: 1, flexBasis: 320, minHeight: 230, borderRadius: 16, padding: 14, borderWidth: 1, borderColor: 'rgba(148,163,184,0.14)' },
  ...
  profileInfo: { flexGrow: 1, flexBasis: 120, minHeight: 54, padding: 10, borderRadius: 12, backgroundColor: 'rgba(15,23,42,0.72)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.1)' },
  ...
  verificationCard: { flexGrow: 1, flexBasis: 360, minHeight: 360, padding: 14, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  ...
  orderCard: { flexGrow: 1, flexBasis: 360, minHeight: 310, padding: 14, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  ...
  timelineDotActive: { backgroundColor: '#7C3AED' },
  ...
  financeLedgerCard: { flexGrow: 1, flexBasis: 360, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  ...
  marketingCard: { flexGrow: 1, flexBasis: 320, minHeight: 260, padding: 14, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  ...
  growthChannelCard: { flexGrow: 1, flexBasis: 260, minHeight: 150, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  supportCard: { flexGrow: 1, flexBasis: 340, minHeight: 270, padding: 14, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
  settingsGrid: { marginTop: 14, flexDirection: 'row', flexWrap: 'wrap', gap: 14, alignItems: 'flex-start' },
  settingsPrimaryCard: { flexGrow: 1, flexBasis: 620, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  settingsSideCard: { flexGrow: 1, flexBasis: 340, borderRadius: 16, backgroundColor: 'rgba(15,23,42,0.78)' },
  sliderCard: { marginTop: 14, minHeight: 88, padding: 14, borderRadius: 14, gap: 12, backgroundColor: 'rgba(15,23,42,0.72)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.12)' },
  sliderTrack: { width: 170, height: 10, borderRadius: 5, overflow: 'hidden', backgroundColor: 'rgba(148,163,184,0.18)' },
  sliderFill: { height: 10, borderRadius: 5, backgroundColor: '#7C3AED' },
  builderSummaryGrid: { marginBottom: 16, flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  builderSummaryCard: { flexGrow: 1, flexBasis: 180, minHeight: 72, padding: 12, borderRadius: 13, backgroundColor: 'rgba(15,23,42,0.76)', borderWidth: 1, borderColor: 'rgba(148,163,184,0.12)' },
  telegramChannelGrid: { marginTop: 14, flexDirection: 'row', flexWrap: 'wrap', gap: 14 },
  telegramChannelCard: { flexGrow: 1, flexBasis: 520, minHeight: 430, padding: 16, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(148,163,184,0.16)' },
