...
export const defaultTranslations: TranslationItem[] = [
  ...
  item('roleSelection.kicker', 'roleSelection', 'Fixora premium access', 'Премиум-доступ Fixora', 'Fixora պրեմիում մուտք'),
  item('roleSelection.title', 'roleSelection', 'Choose your path', 'Выберите роль', 'Ընտրեք ձեր ուղին'),
  item('roleSelection.subtitle', 'roleSelection', 'Select how you want to enter the marketplace', 'Выберите, как войти в маркетплейс', 'Ընտրեք, թե ինչպես մուտք գործել շուկա'),
  item('roleSelection.openAdmin', 'roleSelection', 'Open Pro Admin Panel', 'Открыть Pro Admin Panel', 'Բացել Pro Admin Panel-ը'),
  item('roleSelection.resetDev', 'roleSelection', 'Reset onboarding and location', 'Сбросить онбординг и локацию', 'Վերակայել օնբորդինգն ու տեղադրությունը'),
  item('clientAuth.welcome.title', 'clientAuth', 'Welcome, Client', 'Добро пожаловать, клиент', 'Բարի գալուստ, հաճախորդ'),
  item('clientAuth.login', 'clientAuth', 'Client login', 'Вход клиента', 'Հաճախորդի մուտք'),
  item('clientAuth.register', 'clientAuth', 'Create client account', 'Создать аккаунт клиента', 'Ստեղծել հաճախորդի հաշիվ'),
  item('masterAuth.welcome.title', 'masterAuth', 'Welcome, Master', 'Добро пожаловать, мастер', 'Բարի գալուստ, վարպետ'),
  item('masterAuth.login', 'masterAuth', 'Master login', 'Вход мастера', 'Վարպետի մուտք'),
  item('masterAuth.register', 'masterAuth', 'Create master account', 'Создать аккаунт мастера', 'Ստեղծել վարպետի հաշիվ'),
  item('clientHome.hero.title', 'clientHome', 'Find the best specialists near you', 'Найдите лучших специалистов рядом', 'Գտեք լավագույն մասնագետներին մոտակայքում'),
  item('clientHome.hero.subtitle', 'clientHome', 'Fast booking, verified reviews, secure payments, local pricing.', 'Быстрое бронирование, отзывы, безопасные платежи, локальные цены.', 'Արագ ամրագրում, ստուգված կարծիքներ, անվտանգ վճարումներ։'),
  item('clientHome.categories', 'clientHome', 'Service categories', 'Категории услуг', 'Ծառայությունների կատեգորիաներ'),
  item('clientHome.popularServices', 'clientHome', 'Popular services', 'Популярные услуги', 'Հանրաճանաչ ծառայություններ'),
  item('clientHome.bestNearby', 'clientHome', 'Best masters nearby', 'Лучшие мастера рядом', 'Լավագույն վարպետները մոտակայքում'),
  item('masterDashboard.title', 'masterDashboard', 'Master dashboard', 'Панель мастера', 'Վարպետի վահանակ'),
  ...
  item('professionalProfile.title', 'professionalProfile', 'Professional profile', 'Профиль специалиста', 'Մասնագետի պրոֆիլ'),
  ...
  item('adminRoleCustomization.title', 'adminRoleCustomization', 'Role Customization', 'Настройка ролей', 'Դերերի կարգավորում'),
